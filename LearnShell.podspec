...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/loohawe/LearnShell"
  ...
  s.source       = { :git => "https://github.com/loohawe/LearnShell.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LearnShell/LearnShell/**/*.{h,m,swift}"
